<template>
    ...
    <div class="container">
      ...
      <div class="card-profile">
        <div class="card-profile_visual" :style="{background:`url(${recipesStore.recipe.image}) no-repeat center center/cover`}"></div>
    
        <div class="card-profile_user-infos">
          <span v-if="recipesStore.recipe" class="infos_name">{{recipesStore.recipe.title}}</span>
        ...
        <div class="card-profile_user-stats">
          <div class="stats-holder">
            <div class="user-stats">
              ...
              <span>{{recipesStore.recipe.spoonacularScore}}</span>
            </div>
            <div class="user-stats">
              <strong>Servings</strong>
              <span>{{recipesStore.recipe.servings}}</span>
            </div>
            <div class="user-stats">
              <strong>Health Score</strong>
              <span>{{recipesStore.recipe.healthScore}}</span>
            </div>
          </div>
        </div>
